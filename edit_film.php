...
<header class="header">
   ...
   <li><button class="home"><a href="index.php"><span>Home</a></span></button></li>
    ...
    <?php
    $showsTable = $conn->query('SELECT * FROM films')->fetchAll();
    ?>
    <br><br>
    <br><br><br><br>
    <br><br><br><br>
     <h1 align="center"><div class="btn3"><a href=""><span>Wijzigingsmenu voor films</a></div></span></h1>
    <form action="edit_film.php" method="post" style="display: flex; flex-direction: column; align-items:center;">
        <input type="hidden" name="id" value="<?= $id ?>">
        
        <h2>Titel:<input type="text" name="titel"  class="paddingedit" value="<?= $showsTable[$id2]['titel'] ?>"></h2>
        <br>
        ...
        <tr>
         ...
         <th><div class="btn2"><a href=""><span>Informatie</a></div></span></class></th>
            ...
            <tr>
                <td>Duur</td>
                <td><input type="text" name="duur" class="paddingedit" value="<?= $showsTable[$id]['duur'] ?>"></td>
            </tr>

            <tr>
                <td>Datum van uitkomst</td>
                <td><input type="text" name="datum" class="paddingedit" value="<?= $showsTable[$id]['datum'] ?>"></td>
            </tr>

            <tr>
                <td>Land</td>
                <td><input type="text" name="land" class="paddingedit" value="<?= $showsTable[$id]['land'] ?>"></td>
            </tr>
          
        </table>

        <h2><div class="btn3"><a href=""><span>Beschrijving</a></div></span></h2>
        <input type="text" name="omschrijving" class="paddingedit" value="<?= $showsTable[$id]['omschrijving'] ?>">
