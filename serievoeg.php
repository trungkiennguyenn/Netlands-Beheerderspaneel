...
<header class="header">
   ...
   <li><button class="home"><a href="index.php"><span>Home</a></span></button></li>
    ...
    <br><br>
        ...
        <div class="row">
            <h1 align="center"><div class="btn3"><a href=""><span>Voeg hieronder een serie toe</a></div></span></h1>
            <br><br><br>
            <table class="table table-hover" align="center" border="solid black 2px" width="250px" height="170px">
  
               
                      
                        <td>
                           <a href="add_serie.php?" class="btn"><span>Toevoegen</span></a>
                        </td>                
                    </tr>
