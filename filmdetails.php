...
<header class="header">
   ...
   <li><button class="home"><a href="index.php"><span>Home</a></span></button></li>
    ...
    <br><br>
        ...
        <div class="row">
            <h1 align="center"><div class="btn3"><a href=""><span>Hier vind je alle informatie van de films</a></div></span></h1>
            <br> <br> <br>
   ...
   <tr>
    ...
    <td>
        <a href="detail_film.php?id=<?php echo $film['id']; ?>" class="btn"><span>Details</span></a>
        </td>           
        </tr>
