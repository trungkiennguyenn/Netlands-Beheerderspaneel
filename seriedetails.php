...
<header class="header">
   ...
   <li><button class="home"><a href="index.php"><span>Home</a></span></button></li>
    ...
    <li><a href="filmvoeg.php">Verwijderen</a></li>
      </ul>
    </li>
    ...
    <br><br>
        ...
        <div class="row">
            <h1 align="center"><div class="btn3"><a href=""><span>Hier vind je alle informatie van de series</a></div></span></h1>
            <br><br><br>
            <table class="table table-hover" align="center" border="solid black 2px" width="300px" height="300px">
                ...
                <?php 
                    ...
                    <tr> 
                        ...
                        <a href="detail_serie.php?id=<?php echo $serie['id']; ?>" class="btn"><span>Bekijken</span></a>
                           </td>                
                    </tr>
                                <?php 
                           } 
