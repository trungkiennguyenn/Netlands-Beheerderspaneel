...
<head>
   ...
   <link href="https://fonts.googleapis.com/css2?family=Fredoka+One&family=Play&display=swap" rel="stylesheet"> 
    <title>Hier vind je alle informatie over de series</title>
...
<header class="header">
   ...
   <li><button class="home"><a href="index.php"><span>Home</a></span></button></li>
    ...
    <br><br>
        ...
        <div class="row">
            <h1 align="center"><div class="btn3"><a href=""><span>Selecteer een van de onderstaande series om te wijzigen</a></div></span></h1>
            <br> <br> <br>
            <table class="table table-hover" align="center" border="solid black 2px" width="300px" height="300px">
                ...
                <tr>
                    ...
                    <th><div class="btn2"><a href=""><span>Veranderen</a></div></span></class></th>
                </tr>
                ...
                <?php 
                    ...
                    <tr> 
                        ...
                        <td>
                        <a href="edit_serie.php?id=<?php echo $serie['id']; ?>" class="btn"><span>Wijzig</span></a>
                           </td>                
                             </tr>
                                <?php 
                           } 
