   ...
   <li><button class="home"><a href="index.php"><span>Home</a></span></button></li>
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <h1 align="center"> <div class="btn3"><a href=""><span>Welkom op het Netlands beheerders paneel</a></div></span></h1>
            <br> <br> <br>
            <h2 align="center"><div class="btn3"><a href=""><span>Series</a></div></span></h2>
            <br>
            <table class="table table-hover" align="center" border="solid black 2px" width="300px" height="300px">
                <thead>
                    
                <tr>
                     <th><div class="btn2"><a href=""><span>Titel</a></div></span></th>
                     <th><div class="btn2"><a href=""><span>Rating</a></div></span></class></th>
                </tr>
                ...
                <thead>
                    ...
                    <tr>
                        <th><div class="btn2"><a href=""><span>Titel</a></div></span></th>
                        <th><div class="btn2"><a href=""><span>Duur</a></div></span></class></th>
                    </tr>
                     </tr>
                </thead>
                ...
                <h2 align="center"><div class="btn3"><a href=""><span>Films</a></div></span></h2>
                <br>
                <tbody align="center">
                    <?php 
                           include_once('connection.php');
