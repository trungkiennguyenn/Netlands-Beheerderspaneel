...
<header class="header">
   ...
   <li><button class="home"><a href="index.php"><span>Home</a></span></button></li>
    ...
    <br><br>
        ...
        <div class="row">
            <h1 align="center"><div class="btn3"><a href=""><span>Selecteer een van de onderstaande films om te wijzigen</a></div></span></h1>
            <br> <br> <br>
            <table class="table table-hover" align="center" border="solid black 2px" width="300px" height="300px">
                ...
                <tbody align="center">
                    ...
                    <tr>
                        ...
                        <td>
                        <a href="edit_film.php?id=<?php echo $film['id']; ?>" class="btn"><span>Wijzigen</span></a>
                           </td>           
